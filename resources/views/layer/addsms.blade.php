    ...
    <div class="container-fluid">     
      <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            ...
            <div class="col">
                <p class="head-page-title">Add New SMS Campaign</p>
                                    ...
                                    <div class="card-body">
                                            <div class="form-row">
                                              <div class="form-group-inline col form-data">
                                                <label for="inputSegmentName">Segment Name</label>
                                                <input type="text" class="form-control" id="inputSegmentName" placeholder="Segment Name">
                                              </div>
                                              <div class="form-group-inline col form-data">
                                                <label for="inputContent">Content</label>
                                                <textarea class="form-control" id="inputContent" placeholder="Message Content"></textarea> 
                                              </div>
                                            </div>
