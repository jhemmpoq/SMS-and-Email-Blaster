          ...
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-warning btn-outline-secondary" type="button">Start your free trial</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ asset('images/true.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                <div class="section-heading">
                  <h6>About Us</h6>
                  <h4>Who is SMS & Email <em>Blaster</em></h4>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
            <h6>Our Services</h6>
            <h4>What Our Blaster <em>Provides</em></h4>
            <div class="line-dec"></div>
          </div>
        </div>
        <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="first-thumb active">
                      <div class="thumb">
                        <span class="icon"><img src="{{ asset('images/service-icon-1.png')}}" alt=""></span>
                        SMS
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="{{ asset('images/service-icon-2.png')}}" alt=""></span>
                        Email
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="{{ asset('images/service-icon-3.png')}}" alt=""></span>
                        Sms &amp; Email
                      </div>
                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{ asset('images/services-image-1.png')}}" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{ asset('images/services-image-2.png')}}" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div class="thumb">
                          <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="{{ asset('images/services-image-3.png')}}" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
